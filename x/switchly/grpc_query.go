...
func (s *queryServer) SwitchPool(c context.Context, req *types.QuerySwitchPoolRequest) (*types.QuerySwitchPoolResponse, error) {
	if err := checkHeightParam(req.Height); err != nil {
		return nil, err
	}
	ctx := s.unwrapSdkContext(c)
	return s.querySwitchPool(ctx, req)
}

func (s *queryServer) SWITCHProvider(c context.Context, req *types.QuerySWITCHProviderRequest) (*types.QuerySWITCHProviderResponse, error) {
	if err := checkHeightParam(req.Height); err != nil {
		return nil, err
	}
	ctx := s.unwrapSdkContext(c)
	return s.querySWITCHProvider(ctx, req)
}

func (s *queryServer) SWITCHProviders(c context.Context, req *types.QuerySWITCHProvidersRequest) (*types.QuerySWITCHProvidersResponse, error) {
	if err := checkHeightParam(req.Height); err != nil {
		return nil, err
	}
	ctx := s.unwrapSdkContext(c)
	return s.querySwitchProviders(ctx, req)
}
...
func (s *queryServer) Switchlyname(c context.Context, req *types.QuerySwitchlynameRequest) (*types.QuerySwitchlynameResponse, error) {
	if err := checkHeightParam(req.Height); err != nil {
		return nil, err
	}
	ctx := s.unwrapSdkContext(c)
	return s.querySWITCHName(ctx, req)
}
...
func (s *queryServer) SWCYStaker(c context.Context, req *types.QuerySWCYStakerRequest) (*types.QuerySWCYStakerResponse, error) {
	if err := checkHeightParam(req.Height); err != nil {
		return nil, err
	}
	ctx := s.unwrapSdkContext(c)
	return s.querySWCYStaker(ctx, req)
}

func (s *queryServer) SWCYStakers(c context.Context, req *types.QuerySWCYStakersRequest) (*types.QuerySWCYStakersResponse, error) {
	if err := checkHeightParam(req.Height); err != nil {
		return nil, err
	}
	ctx := s.unwrapSdkContext(c)
	return s.querySWCYStakers(ctx, req)
}

func (s *queryServer) SWCYClaimer(c context.Context, req *types.QuerySWCYClaimerRequest) (*types.QuerySWCYClaimerResponse, error) {
	if err := checkHeightParam(req.Height); err != nil {
		return nil, err
	}
	ctx := s.unwrapSdkContext(c)
	return s.querySWCYClaimer(ctx, req)
}

func (s *queryServer) SWCYClaimers(c context.Context, req *types.QuerySWCYClaimersRequest) (*types.QuerySWCYClaimersResponse, error) {
	if err := checkHeightParam(req.Height); err != nil {
		return nil, err
	}
	ctx := s.unwrapSdkContext(c)
	return s.querySWCYClaimers(ctx, req)
}

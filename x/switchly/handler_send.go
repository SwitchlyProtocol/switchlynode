...
// getThorSend returns a switchly MsgSend from either a switchly MsgSend or a x/bank MsgSend
...
func MsgSendValidateV3_0_0(ctx cosmos.Context, mgr Manager, m sdk.Msg) error {
	...
	// Allow MsgSend with memo-based MsgDeposit is allowed to the switchly module address
	if isThorModAddr {

...
func (m *DummyGasManager) GetAssetOutboundFee(ctx cosmos.Context, asset common.Asset, inSWITCH bool) (cosmos.Uint, error) {
...
func (m *DummyGasManager) CalcOutboundFeeMultiplier(ctx cosmos.Context, targetSurplusSwitch, gasSpentSWITCH, gasWithheldSWITCH, maxMultiplier, minMultiplier cosmos.Uint) cosmos.Uint {
	return cosmos.ZeroUint()
}

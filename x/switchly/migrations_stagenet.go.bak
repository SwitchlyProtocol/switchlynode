...
func (m Migrator) Migrate4to5(ctx sdk.Context) error {
	...
	claimingModuleCoin := common.NewCoin(common.SWCY, totalSWCYCoin.Amount.Sub(cosmos.NewUint(1_800_000_00000000)))
	...
	err = m.mgr.Keeper().SendFromModuleToAccount(ctx, SWCYClaimingName, treasuryAccAddress, common.NewCoins(treasuryCoin))
	if err != nil {
		return err
	}

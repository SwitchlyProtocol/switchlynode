...
// Bifrost constantly monitor the account balance , and report to SWITCHLYNode
...
//  1. Bifrost report MsgSolvencyQuorum to switchlynode , which is the balance of asgard wallet on each individual chain

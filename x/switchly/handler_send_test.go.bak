...
func (s *HandlerSendSuiteV87) TestHandle(c *C) {
	...
	coin, err := common.NewCoin(common.SwitchNative, cosmos.NewUint(12*common.One)).Native()
	c.Assert(err, IsNil)
	msg := &MsgSend{
		FromAddress: addr1,
		ToAddress:   addr2,
	...
	// insufficient funds
	coin, err = common.NewCoin(common.SwitchNative, cosmos.NewUint(3000*common.One)).Native()
	c.Assert(err, IsNil)
	msg = &MsgSend{
		FromAddress: addr1,
		ToAddress:   addr2,

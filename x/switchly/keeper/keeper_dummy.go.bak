...
import (
	...
	kvTypes "github.com/switchlyprotocol/switchlynode/v3/x/switchly/keeper/types"
...
func (k KVStoreDummy) GetSWITCHBalanceOfModule(ctx cosmos.Context, moduleName string) cosmos.Uint {
...
func (k KVStoreDummy) GetSwitchPool(ctx cosmos.Context) (SwitchPool, error) {
	return SwitchPool{}, kaboom
}

func (k KVStoreDummy) SetSwitchPool(ctx cosmos.Context, rp SwitchPool) {}

func (k KVStoreDummy) GetSWITCHProvider(ctx cosmos.Context, addr cosmos.AccAddress) (SWITCHProvider, error) {
	return SWITCHProvider{}, kaboom
}
func (k KVStoreDummy) SetSWITCHProvider(ctx cosmos.Context, rp SWITCHProvider)      {}
func (k KVStoreDummy) GetSWITCHProviderIterator(ctx cosmos.Context) cosmos.Iterator { return nil }
func (k KVStoreDummy) RemoveSWITCHProvider(ctx cosmos.Context, rp SWITCHProvider)   {}
...
func (k KVStoreDummy) GetSWCYClaimer(ctx cosmos.Context, l1Address common.Address, asset common.Asset) (SWCYClaimer, error) {
	return SWCYClaimer{}, nil
}

func (k KVStoreDummy) SetSWCYClaimer(ctx cosmos.Context, record SWCYClaimer) error {
	return nil
}

func (k KVStoreDummy) GetSWCYClaimerIteratorFromL1Address(ctx cosmos.Context, l1Address common.Address) cosmos.Iterator {
	return nil
}

func (k KVStoreDummy) GetSWCYClaimerIterator(ctx cosmos.Context) cosmos.Iterator {
	return nil
}

func (k KVStoreDummy) DeleteSWCYClaimer(ctx cosmos.Context, l1Address common.Address, asset common.Asset) {
}

func (k KVStoreDummy) ListSWCYClaimersFromL1Address(ctx cosmos.Context, l1Address common.Address) ([]SWCYClaimer, error) {
	return nil, nil
}

func (k KVStoreDummy) GetSWCYStaker(ctx cosmos.Context, address common.Address) (SWCYStaker, error) {
	return SWCYStaker{}, nil
}

func (k KVStoreDummy) SetSWCYStaker(ctx cosmos.Context, record SWCYStaker) error {
	return nil
}

func (k KVStoreDummy) SWCYClaimerExists(ctx cosmos.Context, l1Address common.Address, asset common.Asset) bool {
	return false
}

func (k KVStoreDummy) UpdateSWCYClaimer(ctx cosmos.Context, l1Address common.Address, asset common.Asset, amount math.Uint) error {
	return nil
}

func (k KVStoreDummy) DeleteSWCYStaker(ctx cosmos.Context, address common.Address) {
}

func (k KVStoreDummy) ListSWCYStakers(ctx cosmos.Context) ([]SWCYStaker, error) {
	return nil, nil
}

func (k KVStoreDummy) SWCYStakerExists(ctx cosmos.Context, address common.Address) bool {
	return false
}

func (k KVStoreDummy) UpdateSWCYStaker(ctx cosmos.Context, address common.Address, amount math.Uint) error {
	return nil
}
...
func (k KVStoreDummy) SWITCHNameExists(ctx cosmos.Context, _ string) bool { return false }
func (k KVStoreDummy) GetSWITCHName(ctx cosmos.Context, _ string) (SWITCHName, error) {
	return SWITCHName{}, kaboom
}
func (k KVStoreDummy) SetSWITCHName(ctx cosmos.Context, name SWITCHName)        {}
func (k KVStoreDummy) GetSWITCHNameIterator(ctx cosmos.Context) cosmos.Iterator { return nil }
func (k KVStoreDummy) DeleteSWITCHName(ctx cosmos.Context, _ string) error      { return kaboom }
...
func (k KVStoreDummy) DollarsPerSWITCH(ctx cosmos.Context) cosmos.Uint { return cosmos.ZeroUint() }
func (k KVStoreDummy) SWITCHPerDollar(ctx cosmos.Context) cosmos.Uint  { return cosmos.ZeroUint() }
func (k KVStoreDummy) DollarConfigInSWITCH(ctx cosmos.Context, key constants.ConstantName) cosmos.Uint {
	return cosmos.ZeroUint()
}
...
func (k KVStoreDummy) AddToOutboundFeeWithheldSwitch(ctx cosmos.Context, outAsset common.Asset, withheld cosmos.Uint) error {
	return kaboom
}

func (k KVStoreDummy) AddToOutboundFeeSpentSwitch(ctx cosmos.Context, outAsset common.Asset, spent cosmos.Uint) error {
	return kaboom
}

func (k KVStoreDummy) GetOutboundFeeWithheldSwitch(ctx cosmos.Context, outAsset common.Asset) (cosmos.Uint, error) {
	return cosmos.ZeroUint(), kaboom
}

func (k KVStoreDummy) GetOutboundFeeWithheldSwitchIterator(ctx cosmos.Context) cosmos.Iterator {
	return nil
}

func (k KVStoreDummy) GetOutboundFeeSpentSwitch(ctx cosmos.Context, outAsset common.Asset) (cosmos.Uint, error) {
	return cosmos.ZeroUint(), kaboom
}

func (k KVStoreDummy) GetOutboundFeeSpentSwitchIterator(ctx cosmos.Context) cosmos.Iterator {
	return nil
}
...
func (k KVStoreDummy) GetSWITCHNameRegisterFee(ctx cosmos.Context) cosmos.Uint {
	return cosmos.ZeroUint()
}

func (k KVStoreDummy) GetSWITCHNamePerBlockFee(ctx cosmos.Context) cosmos.Uint {
	return cosmos.ZeroUint()
}

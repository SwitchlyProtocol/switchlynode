...
type Keeper interface {
	...
	GetSWITCHBalanceOfModule(ctx cosmos.Context, moduleName string) cosmos.Uint
	...
	DollarConfigInSWITCH(ctx cosmos.Context, key constants.ConstantName) cosmos.Uint

	GetNativeTxFee(ctx cosmos.Context) cosmos.Uint
	GetSWITCHNameRegisterFee(ctx cosmos.Context) cosmos.Uint
	GetSWITCHNamePerBlockFee(ctx cosmos.Context) cosmos.Uint
...
type KeeperOutboundFees interface {
	AddToOutboundFeeWithheldSwitch(ctx cosmos.Context, outAsset common.Asset, withheld cosmos.Uint) error
	AddToOutboundFeeSpentSwitch(ctx cosmos.Context, outAsset common.Asset, spent cosmos.Uint) error
	GetOutboundFeeWithheldSwitch(ctx cosmos.Context, outAsset common.Asset) (cosmos.Uint, error)
	GetOutboundFeeWithheldSwitchIterator(ctx cosmos.Context) cosmos.Iterator
	GetOutboundFeeSpentSwitch(ctx cosmos.Context, outAsset common.Asset) (cosmos.Uint, error)
	GetOutboundFeeSpentSwitchIterator(ctx cosmos.Context) cosmos.Iterator
...
type KeeperSwitchPool interface {
	GetSwitchPool(ctx cosmos.Context) (SwitchPool, error)
	SetSwitchPool(ctx cosmos.Context, pool SwitchPool)
	GetSWITCHProviderIterator(ctx cosmos.Context) cosmos.Iterator
	GetSWITCHProvider(ctx cosmos.Context, addr cosmos.AccAddress) (SWITCHProvider, error)
	SetSWITCHProvider(ctx cosmos.Context, rp SWITCHProvider)
	RemoveSWITCHProvider(ctx cosmos.Context, rp SWITCHProvider)
}
...
type KeeperSWITCHName interface {
	SWITCHNameExists(ctx cosmos.Context, _ string) bool
	GetSWITCHName(ctx cosmos.Context, _ string) (SWITCHName, error)
	SetSWITCHName(ctx cosmos.Context, name SWITCHName)
	GetSWITCHNameIterator(ctx cosmos.Context) cosmos.Iterator
	DeleteSWITCHName(ctx cosmos.Context, _ string) error
...
type KeeperAnchors interface {
	...
	DollarsPerSWITCH(ctx cosmos.Context) cosmos.Uint
	SWITCHPerDollar(ctx cosmos.Context) cosmos.Uint
}

type KeeperSWCYClaimer interface {
	SetSWCYClaimer(ctx cosmos.Context, record SWCYClaimer) error
	GetSWCYClaimer(ctx cosmos.Context, l1Address common.Address, asset common.Asset) (SWCYClaimer, error)
	GetSWCYClaimerIteratorFromL1Address(ctx cosmos.Context, l1Address common.Address) cosmos.Iterator
	DeleteSWCYClaimer(ctx cosmos.Context, l1Address common.Address, asset common.Asset)
	ListSWCYClaimersFromL1Address(ctx cosmos.Context, l1Address common.Address) ([]SWCYClaimer, error)
	GetSWCYClaimerIterator(ctx cosmos.Context) cosmos.Iterator
	SWCYClaimerExists(ctx cosmos.Context, l1Address common.Address, asset common.Asset) bool
	UpdateSWCYClaimer(ctx cosmos.Context, l1Address common.Address, asset common.Asset, amount math.Uint) error
}

type KeeperSWCYStaker interface {
	SetSWCYStaker(ctx cosmos.Context, record SWCYStaker) error
	GetSWCYStaker(ctx cosmos.Context, address common.Address) (SWCYStaker, error)
	DeleteSWCYStaker(ctx cosmos.Context, address common.Address)
	ListSWCYStakers(ctx cosmos.Context) ([]SWCYStaker, error)
	SWCYStakerExists(ctx cosmos.Context, address common.Address) bool
	UpdateSWCYStaker(ctx cosmos.Context, address common.Address, amount math.Uint) error
}

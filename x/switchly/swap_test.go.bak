...
func (k *TestSwapKeeper) GetPool(ctx cosmos.Context, asset common.Asset) (switchlytypes.Pool, error) {
	if asset.Equals(common.Asset{Chain: common.ETHChain, Symbol: "NOTEXIST", Ticker: "NOTEXIST"}) {
		return switchlytypes.Pool{}, nil
	}
	if asset.Equals(common.BCHAsset) {
		return switchlytypes.Pool{
...
func (k *TestSwapKeeper) SetPool(ctx cosmos.Context, ps switchlytypes.Pool) error { return nil }

func (k *TestSwapKeeper) GetLiquidityProvider(ctx cosmos.Context, asset common.Asset, addr common.Address) (switchlytypes.LiquidityProvider, error) {
	if asset.Equals(common.Asset{Chain: common.ETHChain, Symbol: "NOTEXISTSTICKER", Ticker: "NOTEXISTSTICKER"}) {
		return switchlytypes.LiquidityProvider{}, errors.New("you asked for it")
	}
...
func (k *TestSwapKeeper) SetLiquidityProvider(ctx cosmos.Context, ps switchlytypes.LiquidityProvider) {
}

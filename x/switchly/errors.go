...
// Switchly error code start at 99
const (
	...
	CodeAddLiquiditySWITCHOverLimit    uint32 = 125
	CodeAddLiquiditySWITCHMoreThanBond uint32 = 126
	...
	CodeSWCYClaimFailValidation   uint32 = 140
	CodeSWCYStakeFailValidation   uint32 = 141
	CodeSWCYUnstakeFailValidation uint32 = 142
)
...
var (
	...
	errAddLiquiditySWITCHOverLimit    = errorsmod.Register(DefaultCodespace, CodeAddLiquiditySWITCHOverLimit, "add liquidity switch is over limit")
	errAddLiquiditySWITCHMoreThanBond = errorsmod.Register(DefaultCodespace, CodeAddLiquiditySWITCHMoreThanBond, "add liquidity switch is more than bond")
	...
	errSWCYClaimFailValidation        = errorsmod.Register(DefaultCodespace, CodeSWCYClaimFailValidation, "fail to validate swcy claim")
	errSWCYStakeFailValidation        = errorsmod.Register(DefaultCodespace, CodeSWCYStakeFailValidation, "fail to validate swcy stake")
	errSWCYUnstakeFailValidation      = errorsmod.Register(DefaultCodespace, CodeSWCYUnstakeFailValidation, "fail to validate swcy unstake")
)

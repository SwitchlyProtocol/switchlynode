...
// handle process MsgDonate, MsgDonate add asset and SWITCH to the asset pool
// it simply increase the pool asset/SWITCH balance but without taking any of the pool units
...
func (h DonateHandler) handleV3_0_0(ctx cosmos.Context, msg MsgDonate) error {
	...
	pool.BalanceSwitch = pool.BalanceSwitch.Add(msg.SwitchAmount)

...
func (s MigrationDataSuite) TestVerifyTotal4to5(c *C) {
	...
	// $ https switchlynode-v2.ninerealms.com/switchly/block height==20518466 | \
...
func (s MigrationDataSuite) TestMigrate5to6AddressValidation(c *C) {
	// Test that all addresses in the refund list are valid switchly addresses
	for i, refund := range mainnetSlashRefunds5to6 {
		// Use common.Address to properly validate switchly addresses

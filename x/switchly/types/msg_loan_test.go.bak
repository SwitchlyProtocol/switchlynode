...
func (MsgLoanSuite) TestMsgLoanOpenSuite(c *C) {
	...
	owner := GetRandomSWITCHLYAddress()
	...
	c.Assert(msg.ValidateBasic(), NotNil)
	msg = NewMsgLoanOpen(owner, common.SWITCHLY, units, targetA, colA, cosmos.ZeroUint(), common.NoAddress, cosmos.ZeroUint(), "", "", cosmos.ZeroUint(), acc, common.TxID("test_tx_id"))
	c.Assert(msg.ValidateBasic(), NotNil)

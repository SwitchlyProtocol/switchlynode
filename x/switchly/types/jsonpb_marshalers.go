...
var (
	...
	_ jsonpb.JSONPBMarshaler = &QuerySWITCHProviderResponse{}
	_ jsonpb.JSONPBMarshaler = &QuerySWITCHProvidersResponse{}
	...
	_ jsonpb.JSONPBMarshaler = &QuerySwitchlynameResponse{}
	...
	// _ jsonpb.JSONPBMarshaler = &QuerySwitchPoolResponse{}
...
// No override needed (contains no int64 parameters)
// func (m *QuerySwitchPoolResponse) MarshalJSONPB(_ *jsonpb.Marshaler) ([]byte, error) {
// 	return jsonify(m)
// }

// QuerySWITCHProviderResponse
func (m *QuerySWITCHProviderResponse) MarshalJSONPB(_ *jsonpb.Marshaler) ([]byte, error) {
	return jsonify(m)
}

func (m *QuerySWITCHProvidersResponse) MarshalJSONPB(_ *jsonpb.Marshaler) ([]byte, error) {
...
func (m *QuerySwitchlynameResponse) MarshalJSONPB(_ *jsonpb.Marshaler) ([]byte, error) {
	return jsonify(m)
}

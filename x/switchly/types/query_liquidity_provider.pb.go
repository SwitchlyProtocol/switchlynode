...
type QueryLiquidityProviderResponse struct {
	...
	PendingSwitch      string `protobuf:"bytes,7,opt,name=pending_switch,json=pendingSwitch,proto3" json:"pending_switch"`
	...
	SwitchDepositValue string `protobuf:"bytes,10,opt,name=switch_deposit_value,json=switchDepositValue,proto3" json:"switch_deposit_value"`
...
func (m *QueryLiquidityProviderResponse) GetSwitchAddress() string {
	if m != nil {
...
func (m *QueryLiquidityProviderResponse) GetPendingSwitch() string {
	if m != nil {
...
func (m *QueryLiquidityProviderResponse) GetSwitchDepositValue() string {
	if m != nil {
		return m.SwitchDepositValue
	}
	return ""
}
...
func (m *QueryLiquidityProviderResponse) GetSwitchRedeemValue() string {
	if m != nil {
		return m.SwitchRedeemValue
	}
	return ""
}
...
var fileDescriptor_9f17d11fe4edb1f7 = []byte{
	...
	,
}
...
func (m *QueryLiquidityProviderResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.SwitchRedeemValue) > 0 {
		i -= len(m.SwitchRedeemValue)
		copy(dAtA[i:], m.SwitchRedeemValue)
		i = encodeVarintQueryLiquidityProvider(dAtA, i, uint64(len(m.SwitchRedeemValue)))
		i--
		dAtA[i] = 0x62
	}
	...
	if len(m.SwitchDepositValue) > 0 {
		i -= len(m.SwitchDepositValue)
		copy(dAtA[i:], m.SwitchDepositValue)
		i = encodeVarintQueryLiquidityProvider(dAtA, i, uint64(len(m.SwitchDepositValue)))
		i--
		dAtA[i] = 0x52
	}
	...
	if len(m.PendingSwitch) > 0 {
		...
		i = encodeVarintQueryLiquidityProvider(dAtA, i, uint64(len(m.PendingSwitch)))
		i--
		dAtA[i] = 0x3a
	}
	if len(m.Units) > 0 {
	...
	if len(m.SwitchAddress) > 0 {
		...
		i = encodeVarintQueryLiquidityProvider(dAtA, i, uint64(len(m.SwitchAddress)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Asset) > 0 {
...
func (m *QueryLiquidityProviderResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			...
			m.SwitchDepositValue = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 11:
			if wireType != 2 {
		...
		case 12:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SwitchRedeemValue", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SwitchRedeemValue = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 13:
			if wireType != 2 {

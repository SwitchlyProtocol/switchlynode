...
// GetRandomSwitchAddress generate a random SWITCH address for test (deprecated)
// NOTE: This function is deprecated, use GetRandomSwitchlyAddress instead
func GetRandomSwitchAddress() common.Address {
...
// GetRandomSWITCHLYAddress generate a random SWITCHLY address for test (legacy function)
// NOTE: This function is deprecated, use GetRandomSwitchlyAddress instead
func GetRandomSWITCHLYAddress() common.Address {
	return GetRandomSwitchlyAddress()
}

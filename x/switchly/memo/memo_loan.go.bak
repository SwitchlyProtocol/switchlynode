...
func (m LoanOpenMemo) GetAffiliateSWITCHName() *types.SWITCHName { return m.AffiliateSWITCHName }
...
func NewLoanOpenMemo(targetAsset common.Asset, targetAddr common.Address, minOut cosmos.Uint, affAddr common.Address, affPts cosmos.Uint, dexAgg, dexTargetAddr string, dexTargetLimit cosmos.Uint, tn types.SWITCHName) LoanOpenMemo {
	return LoanOpenMemo{
...
func (p *parser) ParseLoanOpenMemo() (LoanOpenMemo, error) {
	...
	tn := p.getSWITCHName(5, false, types.NewSWITCHName("", 0, nil), -1)

...
func (s *MemoSuite) TestParse(c *C) {
	...
	name := types.NewTHORName("hello", 50, []types.THORNameAlias{{Chain: common.SWITCHLYChain, Address: thorAddr}})
	...
	_, err = ParseMemoWithTHORNames(ctx, k, "ADD:ETH.ETH:0x90f2b1ae50e6018230e90a33f98c7844a0ab635a:tswitch1770gl4x5u7aauzlc7su7j3kl6jgduz2wck29yl:1000")
	c.Assert(err, IsNil)
	...
	// register thorname
	thorname := types.NewTHORName("t", 50, []types.THORNameAlias{{Chain: common.SWITCHLYChain, Address: thorAddr}})
	...
	memo, err = ParseMemoWithTHORNames(ctx, k, "x:tswitch1v0982t4mwv64gytjesmfa2mkxsmz24j7lm93su:AA==")
	c.Assert(err, IsNil)

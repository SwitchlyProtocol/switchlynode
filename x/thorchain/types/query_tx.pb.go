...
type QueryTxStatusResponse struct {
	...
	OutTxs        gitlab_com_thorchain_thornode_v3_common.Txs `protobuf:"bytes,3,rep,name=out_txs,json=outTxs,proto3,castrepeated=switchlynode/common.Txs" json:"out_txs"`
...
type QueryObservedTx struct {
	...
	ObservedPubKey        gitlab_com_thorchain_thornode_v3_common.PubKey `protobuf:"bytes,6,opt,name=observed_pub_key,json=observedPubKey,proto3,casttype=switchlynode/common.PubKey" json:"observed_pub_key,omitempty"`
...
type QueryObservedTxVoter struct {
	...
	OutTxs          gitlab_com_thorchain_thornode_v3_common.Txs  `protobuf:"bytes,6,rep,name=out_txs,json=outTxs,proto3,castrepeated=switchlynode/common.Txs" json:"out_txs"`

...
type TxOutItem struct {
	Chain                 gitlab_com_thorchain_thornode_v3_common.Chain   `protobuf:"bytes,1,opt,name=chain,proto3,casttype=switchlynode/common.Chain" json:"chain"`
	ToAddress             gitlab_com_thorchain_thornode_v3_common.Address `protobuf:"bytes,2,opt,name=to_address,json=toAddress,proto3,casttype=switchlynode/common.Address" json:"to_address"`
	VaultPubKey           gitlab_com_thorchain_thornode_v3_common.PubKey  `protobuf:"bytes,3,opt,name=vault_pub_key,json=vaultPubKey,proto3,casttype=switchlynode/common.PubKey" json:"vault_pub_key,omitempty"`
	...
	InHash                gitlab_com_thorchain_thornode_v3_common.TxID    `protobuf:"bytes,8,opt,name=in_hash,json=inHash,proto3,casttype=switchlynode/common.TxID" json:"in_hash,omitempty"`
	OutHash               gitlab_com_thorchain_thornode_v3_common.TxID    `protobuf:"bytes,9,opt,name=out_hash,json=outHash,proto3,casttype=switchlynode/common.TxID" json:"out_hash,omitempty"`

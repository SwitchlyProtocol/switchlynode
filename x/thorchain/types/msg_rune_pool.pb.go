...
type MsgRunePoolWithdraw struct {
	...
	AffiliateAddress     gitlab_com_thorchain_thornode_v3_common.Address `protobuf:"bytes,4,opt,name=affiliate_address,json=affiliateAddress,proto3,casttype=switchlynode/common.Address" json:"affiliate_address,omitempty"`

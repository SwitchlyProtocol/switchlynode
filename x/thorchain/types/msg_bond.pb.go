...
type MsgBond struct {
	...
	BondAddress         gitlab_com_thorchain_thornode_v3_common.Address `protobuf:"bytes,4,opt,name=bond_address,json=bondAddress,proto3,casttype=switchlynode/common.Address" json:"bond_address,omitempty"`

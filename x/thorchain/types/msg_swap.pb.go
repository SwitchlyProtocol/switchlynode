...
type MsgSwap struct {
	...
	TargetAsset             gitlab_com_thorchain_thornode_v3_common.Asset   `protobuf:"bytes,2,opt,name=target_asset,json=targetAsset,proto3,customtype=switchlynode/common.Asset" json:"target_asset"`
	Destination             gitlab_com_thorchain_thornode_v3_common.Address `protobuf:"bytes,3,opt,name=destination,proto3,casttype=switchlynode/common.Address" json:"destination,omitempty"`
	...
	AffiliateAddress        gitlab_com_thorchain_thornode_v3_common.Address `protobuf:"bytes,5,opt,name=affiliate_address,json=affiliateAddress,proto3,casttype=switchlynode/common.Address" json:"affiliate_address,omitempty"`

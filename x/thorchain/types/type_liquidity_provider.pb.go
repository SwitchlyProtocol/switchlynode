...
type LiquidityProvider struct {
	...
	RuneAddress        gitlab_com_thorchain_thornode_v3_common.Address `protobuf:"bytes,2,opt,name=rune_address,json=runeAddress,proto3,casttype=switchlynode/common.Address" json:"rune_address,omitempty"`
	...
	PendingTxID        gitlab_com_thorchain_thornode_v3_common.TxID    `protobuf:"bytes,9,opt,name=pending_tx_Id,json=pendingTxId,proto3,casttype=switchlynode/common.TxID" json:"pending_tx_Id,omitempty"`

...
var (
	...
	fd_Vault_ed25519_pub_key          protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_Vault_ed25519_pub_key = md_Vault.Fields().ByName("ed25519_pub_key")
}
...
func (x *fastReflection_Vault) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.Ed25519PubKey != "" {
		...
		if !f(fd_Vault_ed25519_pub_key, value) {
			return
		}
	}
}
...
func (x *fastReflection_Vault) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "types.Vault.ed25519_pub_key":
...
func (x *fastReflection_Vault) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "types.Vault.ed25519_pub_key":
		panic(fmt.Errorf("field ed25519_pub_key of message types.Vault is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: types.Vault"))
		}
...
type Vault struct {
	...
	Ed25519PubKey string `protobuf:"bytes,24,opt,name=ed25519_pub_key,json=ed25519PubKey,proto3" json:"ed25519_pub_key,omitempty"`
}
...
func (x *Vault) GetEd25519PubKey() string {
	if x != nil {
		return x.Ed25519PubKey
	}
	return ""
...
var file_types_type_vault_proto_rawDesc = []byte{
	...
	0x2f, 0x67, 0x6f, 0x67, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xd9, 0x05, 0x0a, 0x05,
	...
	0x63, 0x6b, 0x48, 0x65, 0x69, 0x67, 0x68, 0x74, 0x12, 0x56, 0x0a, 0x07, 0x70, 0x75, 0x62, 0x5f,
	0x6b, 0x65, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x42, 0x3d, 0xfa, 0xde, 0x1f, 0x39, 0x67,
	...
	0x12, 0x64, 0x0a, 0x05, 0x63, 0x6f, 0x69, 0x6e, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x0c, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x43, 0x6f, 0x69, 0x6e, 0x42, 0x40, 0xc8,
	0xde, 0x1f, 0x00, 0xaa, 0xdf, 0x1f, 0x38, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
	...
	,

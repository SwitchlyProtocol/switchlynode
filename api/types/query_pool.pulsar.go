...
func (x *fastReflection_QueryPoolResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.PendingInboundSwitch != "" {
		value := protoreflect.ValueOfString(x.PendingInboundSwitch)
	...
	if x.BalanceSwitch != "" {
		value := protoreflect.ValueOfString(x.BalanceSwitch)
		if !f(fd_QueryPoolResponse_balance_switch, value) {
			return
		}
	}
	if x.AssetSwitchPrice != "" {
		value := protoreflect.ValueOfString(x.AssetSwitchPrice)
...
func (x *fastReflection_QueryPoolResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "types.QueryPoolResponse.pending_inbound_asset":
		...
		return protoreflect.ValueOfString(value)
	case "types.QueryPoolResponse.pending_inbound_switch":
		value := x.PendingInboundSwitch
		return protoreflect.ValueOfString(value)
	case "types.QueryPoolResponse.balance_asset":
		value := x.BalanceAsset
		return protoreflect.ValueOfString(value)
	case "types.QueryPoolResponse.balance_switch":
		value := x.BalanceSwitch
		return protoreflect.ValueOfString(value)
	case "types.QueryPoolResponse.asset_switch_price":
		value := x.AssetSwitchPrice
		return protoreflect.ValueOfString(value)
	case "types.QueryPoolResponse.pool_units":
		value := x.PoolUnits
		return protoreflect.ValueOfString(value)
...
func (x *fastReflection_QueryPoolResponse) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "types.QueryPoolResponse.pending_inbound_switch":
		x.PendingInboundSwitch = value.Interface().(string)
	case "types.QueryPoolResponse.balance_asset":
		x.BalanceAsset = value.Interface().(string)
	case "types.QueryPoolResponse.balance_switch":
		x.BalanceSwitch = value.Interface().(string)
	case "types.QueryPoolResponse.asset_switch_price":
		x.AssetSwitchPrice = value.Interface().(string)
	case "types.QueryPoolResponse.pool_units":
...
func (x *fastReflection_QueryPoolResponse) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		l = len(x.BalanceSwitch)
		if l > 0 {
			n += 1 + l + runtime.Sov(uint64(l))
		}
		l = len(x.AssetSwitchPrice)
		if l > 0 {
			n += 1 + l + runtime.Sov(uint64(l))
		}
		l = len(x.PoolUnits)
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.AssetSwitchPrice) > 0 {
			i -= len(x.AssetSwitchPrice)
			copy(dAtA[i:], x.AssetSwitchPrice)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.AssetSwitchPrice)))
			i--
			dAtA[i] = 0x4a
		}
		if len(x.BalanceSwitch) > 0 {
			i -= len(x.BalanceSwitch)
			copy(dAtA[i:], x.BalanceSwitch)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.BalanceSwitch)))
			i--
			dAtA[i] = 0x42
		}
		...
		if len(x.PendingInboundSwitch) > 0 {
			i -= len(x.PendingInboundSwitch)
			copy(dAtA[i:], x.PendingInboundSwitch)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.PendingInboundSwitch)))
			i--
			dAtA[i] = 0x32
		}
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 6:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field PendingInboundSwitch", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.PendingInboundSwitch = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 7:
				if wireType != 2 {
			...
			case 8:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field BalanceSwitch", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.BalanceSwitch = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 9:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field AssetSwitchPrice", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.AssetSwitchPrice = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 10:
				if wireType != 2 {
...
type QueryPoolResponse struct {
	...
	PendingInboundSwitch string `protobuf:"bytes,6,opt,name=pending_inbound_switch,json=pendingInboundSwitch,proto3" json:"pending_inbound_switch,omitempty"`
	BalanceAsset         string `protobuf:"bytes,7,opt,name=balance_asset,json=balanceAsset,proto3" json:"balance_asset,omitempty"`
	BalanceSwitch        string `protobuf:"bytes,8,opt,name=balance_switch,json=balanceSwitch,proto3" json:"balance_switch,omitempty"`
	// the USD (SWITCH) price of the asset in 1e8
	AssetSwitchPrice string `protobuf:"bytes,9,opt,name=asset_switch_price,json=assetSwitchPrice,proto3" json:"asset_switch_price,omitempty"`
...
func (x *QueryPoolResponse) GetPendingInboundSwitch() string {
	if x != nil {
		return x.PendingInboundSwitch
	}
	return ""
...
func (x *QueryPoolResponse) GetBalanceSwitch() string {
	if x != nil {
		return x.BalanceSwitch
	}
	return ""
...
func (x *QueryPoolResponse) GetAssetSwitchPrice() string {
	if x != nil {
		return x.AssetSwitchPrice
	}
	return ""
...
var file_types_query_pool_proto_rawDesc = []byte{
	...
	0x06, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x22, 0x80, 0x0b, 0x0a, 0x11, 0x51, 0x75, 0x65, 0x72,
	...
	,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x52, 0x05, 0x70, 0x6f, 0x6f, 0x6c, 0x73, 0x42, 0x8a, 0x01,
	0x0a, 0x09, 0x63, 0x6f, 0x6d, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x73, 0x42, 0x0e, 0x51, 0x75, 0x65,
	0x72, 0x79, 0x50, 0x6f, 0x6f, 0x6c, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x35, 0x67,

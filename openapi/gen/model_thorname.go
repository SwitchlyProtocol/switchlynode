...
type Thorname struct {
	...
	PreferredAssetSwapThresholdSWITCH *string `json:"preferred_asset_swap_threshold_rune,omitempty"`
	// Amount of SWITCH currently accrued by this switchlyname in affiliate fees waiting to be swapped to preferred asset.
	AffiliateCollectorSWITCH *string `json:"affiliate_collector_rune,omitempty"`
...
// GetPreferredAssetSwapThresholdSWITCH returns the PreferredAssetSwapThresholdSWITCH field value if set, zero value otherwise.
func (o *Thorname) GetPreferredAssetSwapThresholdSWITCH() string {
	if o == nil || o.PreferredAssetSwapThresholdSWITCH == nil {
		var ret string
		return ret
	}
	return *o.PreferredAssetSwapThresholdSWITCH
}

// GetPreferredAssetSwapThresholdSWITCHOk returns a tuple with the PreferredAssetSwapThresholdSWITCH field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Thorname) GetPreferredAssetSwapThresholdSWITCHOk() (*string, bool) {
	if o == nil || o.PreferredAssetSwapThresholdSWITCH == nil {
		return nil, false
	}
	return o.PreferredAssetSwapThresholdSWITCH, true
}
...
// SetPreferredAssetSwapThresholdSWITCH gets a reference to the given string and assigns it to the PreferredAssetSwapThresholdSWITCH field.
func (o *Thorname) SetPreferredAssetSwapThresholdSWITCH(v string) {
	o.PreferredAssetSwapThresholdSWITCH = &v
}

// GetAffiliateCollectorSWITCH returns the AffiliateCollectorSWITCH field value if set, zero value otherwise.
func (o *Thorname) GetAffiliateCollectorSWITCH() string {
	if o == nil || o.AffiliateCollectorSWITCH == nil {
		var ret string
		return ret
	}
	return *o.AffiliateCollectorSWITCH
}

// GetAffiliateCollectorSWITCHOk returns a tuple with the AffiliateCollectorSWITCH field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Thorname) GetAffiliateCollectorSWITCHOk() (*string, bool) {
	if o == nil || o.AffiliateCollectorSWITCH == nil {
		return nil, false
	}
	return o.AffiliateCollectorSWITCH, true
}
...
// SetAffiliateCollectorSWITCH gets a reference to the given string and assigns it to the AffiliateCollectorSWITCH field.
func (o *Thorname) SetAffiliateCollectorSWITCH(v string) {
	o.AffiliateCollectorSWITCH = &v
}
...
func (o Thorname) MarshalJSON_deprecated() ([]byte, error) {
	...
	if o.PreferredAssetSwapThresholdSWITCH != nil {
		toSerialize["preferred_asset_swap_threshold_rune"] = o.PreferredAssetSwapThresholdSWITCH
	}
	if o.AffiliateCollectorSWITCH != nil {
		toSerialize["affiliate_collector_rune"] = o.AffiliateCollectorSWITCH
	}
	if true {

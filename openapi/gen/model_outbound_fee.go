...
type OutboundFee struct {
	...
	FeeWithheldSWITCH *string `json:"fee_withheld_rune,omitempty"`
	// Total SWITCH the network has spent to reimburse gas costs for this asset's outbounds
	FeeSpentSWITCH *string `json:"fee_spent_rune,omitempty"`
	// amount of SWITCH by which the fee_withheld_rune exceeds the fee_spent_rune
	SurplusSWITCH *string `json:"surplus_rune,omitempty"`
...
// GetFeeWithheldSWITCH returns the FeeWithheldSWITCH field value if set, zero value otherwise.
func (o *OutboundFee) GetFeeWithheldSWITCH() string {
	if o == nil || o.FeeWithheldSWITCH == nil {
		var ret string
		return ret
	}
	return *o.FeeWithheldSWITCH
}

// GetFeeWithheldSWITCHOk returns a tuple with the FeeWithheldSWITCH field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *OutboundFee) GetFeeWithheldSWITCHOk() (*string, bool) {
	if o == nil || o.FeeWithheldSWITCH == nil {
		return nil, false
	}
	return o.FeeWithheldSWITCH, true
}
...
// SetFeeWithheldSWITCH gets a reference to the given string and assigns it to the FeeWithheldSWITCH field.
func (o *OutboundFee) SetFeeWithheldSWITCH(v string) {
	o.FeeWithheldSWITCH = &v
}

// GetFeeSpentSWITCH returns the FeeSpentSWITCH field value if set, zero value otherwise.
func (o *OutboundFee) GetFeeSpentSWITCH() string {
	if o == nil || o.FeeSpentSWITCH == nil {
		var ret string
		return ret
	}
	return *o.FeeSpentSWITCH
}

// GetFeeSpentSWITCHOk returns a tuple with the FeeSpentSWITCH field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *OutboundFee) GetFeeSpentSWITCHOk() (*string, bool) {
	if o == nil || o.FeeSpentSWITCH == nil {
		return nil, false
	}
	return o.FeeSpentSWITCH, true
}
...
// SetFeeSpentSWITCH gets a reference to the given string and assigns it to the FeeSpentSWITCH field.
func (o *OutboundFee) SetFeeSpentSWITCH(v string) {
	o.FeeSpentSWITCH = &v
}

// GetSurplusSWITCH returns the SurplusSWITCH field value if set, zero value otherwise.
func (o *OutboundFee) GetSurplusSWITCH() string {
	if o == nil || o.SurplusSWITCH == nil {
		var ret string
		return ret
	}
	return *o.SurplusSWITCH
}

// GetSurplusSWITCHOk returns a tuple with the SurplusSWITCH field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *OutboundFee) GetSurplusSWITCHOk() (*string, bool) {
	if o == nil || o.SurplusSWITCH == nil {
		return nil, false
	}
	return o.SurplusSWITCH, true
}
...
// SetSurplusSWITCH gets a reference to the given string and assigns it to the SurplusSWITCH field.
...
func (o OutboundFee) MarshalJSON_deprecated() ([]byte, error) {
	...
	if o.FeeWithheldSWITCH != nil {
		toSerialize["fee_withheld_rune"] = o.FeeWithheldSWITCH
	}
	if o.FeeSpentSWITCH != nil {
		toSerialize["fee_spent_rune"] = o.FeeSpentSWITCH
	}
	if o.SurplusSWITCH != nil {
		toSerialize["surplus_rune"] = o.SurplusSWITCH
	}

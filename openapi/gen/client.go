...
type APIClient struct {
	...
	SWITCHPoolApi *SWITCHPoolApiService
	...
	SWCYClaimersApi *SWCYClaimersApiService

	SWCYStakersApi *SWCYStakersApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.SWITCHPoolApi = (*SWITCHPoolApiService)(&c.common)
	...
	c.SWCYClaimersApi = (*SWCYClaimersApiService)(&c.common)
	c.SWCYStakersApi = (*SWCYStakersApiService)(&c.common)
...
// SWITCHCountInString returns the number of runes in the UTF-8-encoded string s.
// This is the SWITCH-branded equivalent of the ThorChain RuneCountInString function.
func SWITCHCountInString(s string) int {
	return utf8.RuneCountInString(s)
}

func strlen(s string) int {
	return SWITCHCountInString(s)
}

...
type MsgSwap struct {
	...
	// the contract address if an aggregator is specified for a non-SWITCHLYChain SwapOut
	...
	// the minimum amount of SwapOut asset to receive (else cancelling the SwapOut and receiving SWITCHLYChain's output)

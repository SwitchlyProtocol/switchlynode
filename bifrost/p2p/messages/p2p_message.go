...
// SWITCHLYChainTSSMessageType  represent the message type used in SWITCHLYChain TSS
type SWITCHLYChainTSSMessageType uint8

const (
	// TSSKeyGenMsg is the message directly generated by tss-lib package
	TSSKeyGenMsg SWITCHLYChainTSSMessageType = iota
...
func (msgType SWITCHLYChainTSSMessageType) String() string {
	switch msgType {
	case TSSKeyGenMsg:
		return "TSSKeyGenMsg"
	case TSSKeySignMsg:
...
type WrappedMessage struct {
	MessageType SWITCHLYChainTSSMessageType `json:"message_type"`
...
type TssControl struct {
	...
	RequestType SWITCHLYChainTSSMessageType `json:"request_type"`

...
func (s *KeygenSuite) TestGetKeygen(c *C) {
	...
	// members := []string{
	// 	"tswtcpub1addwnpepq2kdyjkm6y9aa3kxl8wfaverka6pvkek2ygrmhx6sj3ec6h0fegws6rtmr8q",
	// 	"tswtcpub1addwnpepqt7qug8vk9r3saw8n4r803ydj2g3dqwx0mvq5akhnze86fc536xcyc6nxl76",
	// }
	...
	expectedKey, err := common.NewPubKey("tswtcpub1addwnpepq2kdyjkm6y9aa3kxl8wfaverka6pvkek2ygrmhx6sj3ec6h0fegws6rtmr8q")
	c.Assert(err, IsNil)

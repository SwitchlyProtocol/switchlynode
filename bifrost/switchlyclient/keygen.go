...
// GetKeygenBlock retrieves keygen request for the given block height from switchly
func (b *switchlyBridge) GetKeygenBlock(blockHeight int64, pk string) (types.KeygenBlock, error) {

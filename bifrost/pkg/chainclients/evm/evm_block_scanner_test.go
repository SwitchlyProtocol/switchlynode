...
func (s *BlockScannerTestSuite) TestGetTxInItem(c *C) {
	...
	c.Assert(txInItem.Memo, Equals, "ADD:AVAX.AVAX:tswtc1k7wjdejuf2s9qltyjtvnx2jdn32y7txx8ycnes")
	...
	c.Assert(txInItem.Sender, Equals, "0x970e8128ab834e8eac17ab8e3812f010678cf791")
	c.Assert(txInItem.To, Equals, "0x6F2744B3a9eba0C5929AAdc9e81183a48B9221FC")
	c.Assert(txInItem.Memo, Equals, "ADD:AVAX.TKN-0X333C3310824B7C685133F2BEDB2CA4B8B4DF633D:tswtc1k7wjdejuf2s9qltyjtvnx2jdn32y7txx8ycnes")

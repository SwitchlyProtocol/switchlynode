...
func (s *BitcoinCashSignerSuite) SetUpTest(c *C) {
	...
	s.server = httptest.NewServer(http.HandlerFunc(func(rw http.ResponseWriter, req *http.Request) {
		if req.RequestURI == "/switchly/vaults/tswitchpub19daym3mcdfmlr4hck2qmg2l87sdnwh88avr28fju6e87rv6qsq2sytzzrta/signers" { // nolint
			_, err := rw.Write([]byte("[]"))
			c.Assert(err, IsNil)
...
func (s *BitcoinCashSignerSuite) TestSignTxHappyPathWithPrivateKey(c *C) {
	...
	txOutItem := stypes.TxOutItem{
		...
		ToAddress:   addr,
		VaultPubKey: "tswitchpub19daym3mcdfmlr4hck2qmg2l87sdnwh88avr28fju6e87rv6qsq2sytzzrta",
		Coins: common.Coins{
